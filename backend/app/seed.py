...
WHEEL = [
    ("w1", "−10% продление", "#ffffff", False, "promo", 0, 18),
    ("w2", "100 моггсов", "#2b2b2b", False, "moggs", 100, 20),
    ("w3", "Разбор куратора", "#d9d9d9", False, "promo", 0, 6),
    ("w4", "В другой раз", "#1e1e1e", True, "none", 0, 22),
    ("w5", "−25% мерч", "#ededed", False, "promo", 0, 12),
    ("w6", "Гайд отёки", "#3d3d3d", False, "promo", 0, 14),
    ("w7", "В другой раз", "#b5b5b5", True, "none", 0, 22),
    ("w8", "−50% продление", "#4f4f4f", False, "promo", 0, 3),
]
